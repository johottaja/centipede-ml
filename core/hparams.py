...
SPECS: list[tuple] = [
    ...
    ("V-min",                  "v-min",                  "-10",     "float", None, None, "Minimum return value in the C51 support"),
    ("V-max",                  "v-max",                  "10",      "float", None, None, "Maximum return value in the C51 support"),
    ("Max grad norm",          "max-grad-norm",          "10",      "float", 0,    None, "Gradient clipping threshold (L2 norm) applied after each backward pass"),
